          ...
          {navLinks.map(({ label, href }) => (
            <li key={label} role="none">
              <Link
                href={href}
                role="menuitem"
                className={`text-[13pt] font-bold uppercase hover:opacity-50 transition-all duration-300 whitespace-nowrap ${isTransparent ? 'text-white drop-shadow-md' : 'text-wokcop-dark'}`}
